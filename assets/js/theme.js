class ThemeToggle {
        ...
        toggle.innerHTML = `
            <div class="theme-toggle-container">
                <div class="theme-toggle-option">
                    <input type="radio" name="theme" value="system" ${this.theme === 'system' ? 'checked' : ''}>
                ...
                <div class="theme-toggle-option">
                    <input type="radio" name="theme" value="light" ${this.theme === 'light' ? 'checked' : ''}>
                    <svg viewBox="0 0 28 28" fill="none">
                ...
                <div class="theme-toggle-option">
                    <input type="radio" name="theme" value="dark" ${this.theme === 'dark' ? 'checked' : ''}>
                    <svg viewBox="0 0 28 28" fill="none">
    ...
    bindEvents() {
        // Listen for theme radio button changes
